        ...
        {({ values, setFieldValue, isSubmitting }) => (
          <Form style={{ display: "flex", flexWrap: "wrap" }}>
            <div className="form_section">
              ...
              {["styleNum", "name", "price", "category"].map(function (
                item,
                i
              ) {
                return (
            ...
            <div className="form_section">
              <FormLabel className="form_label" component="legend">
                Supplier
              </FormLabel>
            ...
            <Button
              ...
              type="submit"
              variant="contained"
              style={{ width: "100%", marginTop: "3%", padding: "1rem" }}
            >
              {props.isEditing ? `Submit changes` : `Add Garment`}
            </Button>
          </Form>
        )}
      </Formik>
